...
import { rollbackPrompt, setAgentActionsEnabled } from './actions'
  ...
  return (
    <div className="space-y-8">
      ...
      <section>
        ...
        <p className="mt-1 text-sm text-ink-500">Each customer has one agent running the prompt above. New restaurants start in <b>observe-only</b>: the agent reads, flags and recommends but changes nothing until you switch on "Agent changes" here. Open one to pause its daily cron, run the routine now, or read its recent runs.</p>
